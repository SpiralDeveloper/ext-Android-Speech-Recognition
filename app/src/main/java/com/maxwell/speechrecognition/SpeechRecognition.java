...
public class SpeechRecognition {
    ...
    public SpeechRecognition(Context context,RecognitionProgressView recognitionProgressView){
    ...
    public void startSpeechRecognition(){
        ...
        SpeechRecognitionListener speechRecognitionListener = new SpeechRecognitionListener(
                this.onSpeechRecognitionListener, context,recognitionProgressView);
